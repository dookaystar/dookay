...
public abstract class SecondChoiceTopPopup extends BasePopupWindow {
    ...
    public SecondChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView) {
        super(activity1);
     ...
     */
    public SecondChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView, int okIteme, int colorlinee, int colorTxte, int colorClikTxte) {
        super(activity1);
        this.oKItem = okIteme;

...
public abstract class ChoiceTopPopup extends BasePopupWindow {
    private List<String> stringList;
    private Activity activity;

    public ChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView) {
        super(activity1);
     ...
     */
    public ChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView, int okIteme, int colorlinee, int colorTxte, int colorClikTxte) {
        super(activity1);
        this.oKItem = okIteme;

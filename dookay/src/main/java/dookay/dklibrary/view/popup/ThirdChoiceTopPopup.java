...
public abstract class ThirdChoiceTopPopup extends BasePopupWindow {
    private List<String> stringList;
    private Activity activity;

    public ThirdChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView) {
        super(activity1);
     ...
     */
    public ThirdChoiceTopPopup(Activity activity1, List<String> stringList1, int layoutView, int okIteme, int colorlinee, int colorTxte, int colorClikTxte) {
        super(activity1);
        this.oKItem = okIteme;

...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFFF7600;    //  引导线
    private int underlineColor = 0x1AFF7600;
    private int dividerColor = 0x1AFF7600;
    ...
    private void updateTabStyles() {
      ...
      /*      v.setBackgroundResource(tabBackgroundResId);*/
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextColor(i == 0 ? getResources().getColor(R.color.color_orange_3) : tabTextColor);
                if (textAllCaps) {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ? getResources().getColor(R.color.color_orange_3) : tabTextColor);
                }
            }
        }
    }
